...
class CreateClaimRequest(object):
    ...
    def __init__(self, tracking_id=None, declared_value=None, claim_reason=None, is_replacement_package_sent=None, proofs=None, settlement_type=SettlementType.REFUND, _configuration=None):  # noqa: E501
